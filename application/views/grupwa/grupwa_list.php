...
<div class="container">
  ...
  <h4 class="alert-heading">Set Group Wa </h4>
  <p>Berfungsi Untuk menambah atau menghapus dan mengedit group wa</p>
  <hr>
  <p class="mb-0">Regards Developers</p>
</div>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Daftar Group WhatsApp</h2>
            </div>
            ...
            <div class="col-md-4 text-right">
                <?php echo anchor(site_url('grupwa/create'), 'Create', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('grupwa/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('grupwa/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
        </div>
      ...
      <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "grupwa/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_group",
                            "orderable": false
                        },{"data": "nama_group"},{"data": "nm_jns_daftar"},{"data": "link"},{"data": "tahun_ajaran"},{"data": "nm_lemb"},
                        {
                            "data" : "action",
                            "orderable": false,
