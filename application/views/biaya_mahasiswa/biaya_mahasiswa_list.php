...
<div class="alert alert-success" role="alert">
  ...
  <p class="mb-0">Regards Developers</p>
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Daftar Biaya Mahasiswa</h2>
            </div>
            ...
            <div class="col-md-4 text-right">
                <?php echo anchor(site_url('biaya_mahasiswa/create'), 'Create', 'class="btn btn-primary"'); ?>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "biaya_mahasiswa/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_biaya",
                            "orderable": false
                        },{"data": "nm_jns_daftar"},{"data": "acc"},{"data": "nama_biaya"},{"data": "jumlah_biaya",
                "render": function(data, type, row) {
                    // Konversi ke tipe data numerik
                    var jumlahBiayaNumerik = parseFloat(data);
                    
                    // Terapkan format Rupiah
                    var jumlahBiayaRupiah = jumlahBiayaNumerik.toLocaleString('id-ID', { style: 'currency', currency: 'IDR' });
                    
                    return jumlahBiayaRupiah;
                }
            },{"data": "set_biaya"},{"data": "id_smt"},{"data": "nm_lemb"},
                        {
                            "data" : "action",
                            "orderable": false,
