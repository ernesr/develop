...
<div class="container">
  ...
  <div class="card-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Data Mahasiswa Yang sudah Bayar Uang Pendaftaran </h2>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "permohonan_daftar_mhs/json/<?php echo $date;?>", "type": "POST"},
                    columns: [
                        {
                            "data": "id_permohonan_daftar_mhs",
                            "orderable": false
                        },{"data": "id_permohonan_daftar_mhs"},{"data": "nama_lengkap"},{"data": "no_hp"},{"data": "no_hp_ortu"},{"data": "nik"},{"data": "nm_lemb"},{"data": "alter"},{"data": "price"},
                        {
                            "data" : "action",
                            "orderable": false,
