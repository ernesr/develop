...
<div class="container">
  ...
  <div class="card-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Data Mahasiswa Yang sudah Bayar Uang Regis</h2>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url();?>permohonan_daftar_mhs/json2/<?php echo $date;?>", "type": "POST"},
                    columns: [
                        {
                            "data": "id_reg_pd",
                            "orderable": false
                        },{"data": "nipd"},{"data": "nm_pd"},{"data": "no_hp"},{"data": "nm_lemb"},{"data": "total"},
                        {
                            "data" : "action",
                            "orderable": false,
